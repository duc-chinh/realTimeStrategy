...
import realTimeStrategy.mapObjects.unitObject.Miner;

public class MinerAction extends AbstractAction
{
	private static final long serialVersionUID = 1L;
	private Game game;
	private Player player;
	public MinerAction(String str, Game game, Player player)
	{
		super(str);
		this.game = game;
		this.player = player;
	...
	public void actionPerformed(ActionEvent arg0)
	{
		if(player.getSelectedUnit() != null)
		{
			...
			player.getSelectedUnit().setRole(new Miner());
